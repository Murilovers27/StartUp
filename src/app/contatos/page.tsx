...
interface TeamMember {
  ...
  contactIcon?: React.ElementType; // Ícone customizado para o botão de contato
}
...
export default function ContatosPage() {
  ...
  const teamMembers: TeamMember[] = [
    ...
    {
      id: "m2",
      name: "[Nome Dev Front 1]",
      role: "Desenvolvedor Front-End",
      linkedinUrl: "https://www.linkedin.com/in/seu-usuario/",
      instagramUrl: "https://www.instagram.com/seu-usuario/",
      contactLink: "mailto:frontend1@example.com",
      contactText: "Email",
      contactIcon: FaEnvelope
    },
    {
      id: "m3",
      name: "[Nome Dev Front 2]", // Ou outra função
      role: "Desenvolvedor Front-End",
      linkedinUrl: "https://www.linkedin.com/in/seu-usuario/",
      instagramUrl: "https://www.instagram.com/seu-usuario/",
